...
public class EAGoToLevel extends Command {
    ...
    public void initialize() {
        ...
        System.err.println("EAGoToLevel initialized");
    ...
    @Override
    public void execute() {
        bDone = RobotContainer.getInstance().m_elevatorAndArm.isElevatorAndArmAtTarget(targPos);
         System.err.println("EAGoToLevel executing");
