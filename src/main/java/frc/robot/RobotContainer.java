...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    // SmartDashboard.putData("run test command",
  ...
  public void updateDashboard() {
    ...
    SmartDashboard.putString("Curr Selected Target pos",
        m_driverAssist.getCurrSelectedTargets().getTargetPose().toString());
    SmartDashboard.putString("Curr Selected Target Type",
        m_driverAssist.getCurrSelectedTargets().getTargetType().toString());
  ...
  private void configureButtonBindings() {
    ...
    /*
     * A_Drive.onTrue(new
     * DriveToPos(m_driverAssist.getCurrSelectedTargets().getTargetPose(),
     * m_driveTrain)
     * .until(() -> Math.abs(drive_Controller.getLeftY()) > 0.1 ||
     * Math.abs(drive_Controller.getLeftX()) > 0.1 || Math
    ...
    B_Drive.onTrue(new SetTarget(Launcher.KnownTargets.RED_HUB.getPose2d()))
        .onTrue(new DriveToPos(DriverAssist.Targets.RRIGHTSTART.getTargetPose())
            .until(
    ...
    X_Drive.onTrue(new SetTarget(Launcher.KnownTargets.BLUE_HUB.getPose2d()))
        .onTrue(new DriveToPos(DriverAssist.Targets.RRIGHTCLIMB.getTargetPose())
            .until(
                () -> Math.abs(drive_Controller.getLeftY()) > 0.1 || Math.abs(drive_Controller.getLeftX()) > 0.1 || Math
                    .abs(drive_Controller.getRightX()) > 0.1));
