...
import frc.robot.commands.drivebase.cmdResetGyro;
import frc.robot.commands.*;
import frc.robot.commands.driverAssist.tacticCmd;
...
public class RobotContainer {
  ...
  private Command m_tacticLastSelectedCommand = null;
 ...
 public SendableChooser<Command> m_tacticChooser = new SendableChooser<>();
  ...
  private RobotContainer() {
    ...
    m_tacticChooser.setDefaultOption("Tactic T1", new tacticCmd(DriverAssist.TACTIC_APPROACH.T1));

    m_tacticChooser.addOption("Tactic T2", new tacticCmd(DriverAssist.TACTIC_APPROACH.T2));
    m_tacticChooser.addOption("Tactic T3", new tacticCmd(DriverAssist.TACTIC_APPROACH.T3));
    m_tacticChooser.onChange(selectedCommand -> {
          if (selectedCommand != m_tacticLastSelectedCommand) {
                if(m_tacticLastSelectedCommand != null) {
                  m_tacticLastSelectedCommand.cancel();
                }
   ...
   SmartDashboard.putData("Tactics", m_tacticChooser);
  ...
  SmartDashboard.putNumber("Drivetrain Velocity Y", m_driveTrain.getFieldVelocity().vyMetersPerSecond);
   ...
   SmartDashboard.putBoolean("bPickup", m_sensors.bPickup);
  }
