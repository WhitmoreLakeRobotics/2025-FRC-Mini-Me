...
public class RobotContainer {
 ...
 public SendableChooser<Command> m_tacticChooser = new SendableChooser<>();
  ...
  private RobotContainer() {
    ...
    autoChooser.setDefaultOption("Start-Climb", new PathPlannerAuto("Start-climb.auto"));
    autoChooser.addOption("Test Drive Straight", new PathPlannerAuto("Test Drive Straight.auto"));
