...
public class Launcher extends SubsystemBase {
    ...
    private Pose2d targetPose = KnownTargets.RED_HUB.getPose2d();
    ...
    */
    public Launcher() {
        ...
        //LFlywheels flywheels_LH = new LFlywheels(MOTORS.TOWER1_MOTOR_RIGHT.canId, MOTORS.TOWER1_MOTOR_LEFT.canId);
        //LFlywheels flywheels_RH = new LFlywheels(MOTORS.TOWER2_MOTOR_RIGHT.canId, MOTORS.TOWER2_MOTOR_LEFT.canId);
         turret = new LTurret();
    }
